import { array, maxLength, nonEmpty, nullable, number, object, pipe, regex, string, transform, unknown, type InferOutput } from "valibot";
...
(
    {
        ...
        descripcion:pipe(string(), nonEmpty('La descripción no puede estar vacía'), maxLength(255, 'La descripción no puede exceder los 255 caracteres')),
    }
);
